...
ALTER TABLE TAU_CA ADD CONSTRAINT CK_TAU_CA_3 CHECK (TrangThaiDuyet = 'DA DUYET' OR TrangThaiHoatDong = 'DANG CHO|CHUA DK');
ALTER TABLE TAU_CA ADD CONSTRAINT CK_TAU_CA_4 CHECK (CongSuat >= 0);
ALTER TABLE TAU_CA ADD CONSTRAINT CK_TAU_CA_5 CHECK (ChieuDai >= 0);
ALTER TABLE TAU_CA ADD CONSTRAINT CK_TAU_CA_6 CHECK (NamDongTau >= 0);
...
ALTER TABLE CHUYEN_DANH_BAT ADD CONSTRAINT CK_CHUYEN_DANH_BAT_3 CHECK (NgayXuatBen <= NgayCapBen);
ALTER TABLE CHUYEN_DANH_BAT ADD CONSTRAINT CK_CHUYEN_DANH_BAT_4 CHECK (TongKhoiLuong >= 0);
ALTER TABLE CHUYEN_DANH_BAT ADD CONSTRAINT CK_CHUYEN_DANH_BAT_5 CHECK (TrangThaiDuyet = 'DA DUYET' OR TrangThaiHoatDong = 'DANG CHO');

ALTER TABLE LOG_HAI_TRINH ADD CONSTRAINT CK_LOG_HAI_TRINH_1 CHECK (HuongDiChuyen >= 0 AND HuongDiChuyen < 360);

ALTER TABLE ME_CA ADD CONSTRAINT CK_ME_CA_1 CHECK (ThoiGianThaLuoi <= ThoiGianKeoLuoi);
ALTER TABLE ME_CA ADD CONSTRAINT CK_ME_CA_2 CHECK (KhoiLuong >= 0);

ALTER TABLE DANHBAT_THUYSAN ADD CONSTRAINT CK_DANHBAT_THUYSAN_1 CHECK (KhoiLuongMeCa >= 0);

ALTER TABLE LOG_DUONG_DI_BAO ADD CONSTRAINT CK_LOG_DUONG_DI_BAO_1 CHECK (Mucdo IN (1,2,3,4,5));

ALTER TABLE NGU_TRUONG ADD CONSTRAINT CK_NGU_TRUONG_1 CHECK (SoLuongTauHienTai >= 0 AND SoLuongTauHienTai <= SoLuongTauToiDa);
ALTER TABLE NGU_TRUONG ADD CONSTRAINT CK_NGU_TRUONG_2 CHECK (SoLuongTauToiDa >= 0);
...
ALTER TABLE DANHBAT_THUYSAN DROP CONSTRAINT FK_DANHBAT_THUYSAN_1;
ALTER TABLE DANHBAT_THUYSAN DROP CONSTRAINT FK_DANHBAT_THUYSAN_2;
